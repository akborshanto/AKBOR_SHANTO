...
const Footer = () => {
  return (
    ...
    <a target="_blank" 
      href="https://www.facebook.com/akbor.shanto.1"
      aria-label="LinkedIn"
    ...
    <li class="icon-content">
      <a target="_blank" 
        href="https://www.linkedin.com/in/akborshanto/"
        aria-label="LinkedIn"
        data-social="linkedin"
      >
        <div class="filled"></div>
    ...
    <li class="icon-content">
      <a href="https://github.com/akborshanto" aria-label="GitHub" data-social="github" target="_blank" >
        <div class="filled"></div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
